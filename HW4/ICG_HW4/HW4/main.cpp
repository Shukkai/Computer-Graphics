...
int main()
{
	...
	double currentTime;
	unsigned int mLoc, vLoc, pLoc,timeLoc,wayLoc;
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		mLoc = glGetUniformLocation(programs, "M");
		vLoc = glGetUniformLocation(programs, "V");
		pLoc = glGetUniformLocation(programs, "P");
		timeLoc = glGetUniformLocation(programs, "time");
		wayLoc = glGetUniformLocation(programs, "way");
		...
		glUniform1f(timeLoc,amount);
		glUniform1i(wayLoc, way);
